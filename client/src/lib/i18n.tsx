...
const translations = {
    ...
    ja: {
        home_title: "HappyGames",
        home_subtitle: "ゲームをプレイして、ハッピービーンズを稼ぎ、Piを獲得しよう！",
        welcome: "ようこそ、パイオニア！",
        ...
        login_required: "ホームページからログインしてください。",
        go_home: "ホームへ",
        promoter: "プロモーター",
        member: "メンバー",
        referral_stats: "紹介統計",
        invited_users: "招待ユーザー数",
        total_flow: "総フロー",
        referral_link: "紹介リンク",
        logout: "ログアウト",
        ...
        wallet: {
            ...
            beans: "ハッピービーンズ",
            commission: "手数料",
            alert: "柔軟な送金：個人のウォレットや取引所のアカウントを含む、あらゆるPiアドレスから入出金が可能です。",
            tab_deposit: "入金 (Pi → ビーンズ)",
            tab_withdraw: "出金 (ビーンズ → Pi)",
            deposit_addr: "専用入金アドレス",
            no_memo: "メモ不要：このアドレスはあなた専用です。",
            step1: "ステップ1：上記のアドレスにPiを送金します。",
            step2: "ステップ2：下の「送金しました」をクリックします。",
            deposit_tip: "送金後、下のボタンをクリックしてください。ブロックチェーン上の入金を自動的にスキャンします。",
            check_deposit: "送金しました（入金確認）",
            withdraw_addr: "出金アドレス",
            amount_beans: "数量 (ビーンズ)",
            withdraw_btn: "出金",
            history: "取引履歴",
            col_type: "タイプ",
            col_amount: "金額",
    ...
    ko: {
        home_title: "HappyGames",
        home_subtitle: "게임을 즐기고, 해피빈을 얻고, Pi를 획득하세요!",
        welcome: "환영합니다, 파이오니어!",
        ...
        wallet: {
            ...
            beans: "해피빈",
            commission: "수수료",
            alert: "유연한 이체: 개인 지갑이나 거래소 계정을 포함한 모든 Pi 주소에서 입금하거나 출금할 수 있습니다.",
            tab_deposit: "입금 (Pi → 해피빈)",
            tab_withdraw: "출금 (해피빈 → Pi)",
            deposit_addr: "전용 입금 주소",
            no_memo: "메모 필요 없음: 이 주소는 귀하에게 고유합니다.",
            step1: "1단계: 위 주소로 Pi를 이체하세요.",
            step2: "2단계: 아래 '이체했습니다'를 클릭하세요.",
            deposit_tip: "이체 후 아래 버튼을 클릭하세요. 블록체인에서 입금을 자동으로 스캔합니다.",
            check_deposit: "이체했습니다 (입금 확인)",
            withdraw_addr: "출금 주소",
            amount_beans: "수량 (해피빈)",
            withdraw_btn: "출금",
            history: "거래 내역",
    ...
    ar: {
        ...
        coming_soon: "قريبا",
        lucky_dice: "نرد الحظ",
        high_stakes: "مخاطر عالية، مكافآت عالية.",
        edit_nickname: "تعديل اللقب",
        enter_nickname: "أدخل اللقب الجديد",
        save: "حفظ",
        beans: "فاصوليا",
        texas_holdem: "تكساس هولديم",
    },
    vi: {
        home_title: "HappyGames",
