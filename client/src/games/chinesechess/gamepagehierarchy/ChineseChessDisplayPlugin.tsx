    ...
    <main className="min-h-screen bg-gradient-to-b from-amber-50 to-amber-100 p-4 flex items-center justify-center">
      <div className="w-full max-w-md">
        <button
          ...
          className="mb-4 p-2 bg-white rounded-full shadow-md hover:bg-amber-100 transition-colors"
          aria-label="返回并离座"
        >
        ...
        <div className="bg-white rounded-lg p-4 shadow-lg border-4 border-orange-500">
          <ChessBoard 
            pieces={pieces}
