...
## 17. ��Ϸƥ������ģ�� (Game Match Flow Template)

**���¸���**: 2025-11-28

Ϊ��ȷ��������Ϸ��ƥ������һ���ԺͿ�ά���ԣ����Ǵ����˱�׼������Ϸƥ������ģ�塣
...
1. **״̬����**: ���� UI �仯��״̬����
2. **ʵʱͬ��**: ʹ�� Socket.IO ʵʱ�㲥״̬
3. **�û��Ѻ�**: ����Ϸ����Ƭ��ֱ�Ӳ��������赯��
4. **�ݴ���**: ����������������ʱ���쳣���

### 17.2 ��׼����

waiting (�ȴ���)  ready_check (׼�����)  playing (��Ϸ��)  ended (�ѽ���)

### 17.3 �й�����ʵ��

�й�������ȫ��ѭ��ģ��ʵ�֣��Ǳ�׼�Ĳο�ʵ�֡�
...
1. **����״̬���� ready_check ������**
   - �� MatchRoomState.addPlayer() ���Ƴ� startReadyCheck() ����
   - �� MatchableGameRoom ͳһ����׼���������
   - �� removePlayer() ��ǿ������״̬Ϊ waiting

2. **�����б�ʵʱ��������**
   - �� BaseGameManager ������ broadcastRoomList(tier) ����
   - �� broadcastRoomState() �е��� gameManager.broadcastRoomList()
   - �ͻ����Զ�����㲥�����Խ���ʵʱ����
...
- ���� GAME_MATCH_FLOW_TEMPLATE.md - ��Ϸƥ������ģ��
- ���� development_docs.md - ���ӱ��θ��µ���ϸ��¼
