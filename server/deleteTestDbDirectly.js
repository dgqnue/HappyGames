...
async function deleteTestDb() {
    const client = new MongoClient(process.env.MONGO_URI || 'mongodb+srv://HappyGames_db_user:HappyGames888!@happygames.ao5zdwu.mongodb.net/happygames?appName=HappyGames');
